...
use super::honk_verifier_circuits::{
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_52_circuit,
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_52_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_15_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_52P_RLC_circuit,
    };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_15_PUB_52_circuit(
                ...
                sumcheck_univariate_5: (*full_proof.proof.sumcheck_univariates.at(5)),
                sumcheck_univariate_6: (*full_proof.proof.sumcheck_univariates.at(6)),
                sumcheck_univariate_7: (*full_proof.proof.sumcheck_univariates.at(7)),
                sumcheck_univariate_8: (*full_proof.proof.sumcheck_univariates.at(8)),
                sumcheck_univariate_9: (*full_proof.proof.sumcheck_univariates.at(9)),
                sumcheck_univariate_10: (*full_proof.proof.sumcheck_univariates.at(10)),
                sumcheck_univariate_11: (*full_proof.proof.sumcheck_univariates.at(11)),
                sumcheck_univariate_12: (*full_proof.proof.sumcheck_univariates.at(12)),
                sumcheck_univariate_13: (*full_proof.proof.sumcheck_univariates.at(13)),
                sumcheck_univariate_14: (*full_proof.proof.sumcheck_univariates.at(14)),
            ...
            full_proof.msm_hint_batched.SumDlogDivBatched.validate_degrees_batched(52);
