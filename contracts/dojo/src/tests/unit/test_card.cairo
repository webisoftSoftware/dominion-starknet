...
fn test_encrypt() {
    ...
    let expected_num_representation: u32 = expected_card_value * 256_u32 + expected_card_suit;

    assert!(card.m_num_representation == expected_num_representation.try_into().unwrap());
}
