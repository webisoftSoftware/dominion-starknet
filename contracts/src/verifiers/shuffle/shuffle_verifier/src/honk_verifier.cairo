...
use super::honk_verifier_circuits::{
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_104_circuit,
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{
        vk, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_104_circuit,
        run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_16_circuit,
        run_BN254_EVAL_FN_CHALLENGE_DUPL_53P_RLC_circuit,
    };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_16_PUB_104_circuit(
            ...
            full_proof.msm_hint_batched.SumDlogDivBatched.validate_degrees_batched(53);
